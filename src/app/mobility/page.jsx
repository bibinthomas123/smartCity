...
const tramLines = [
  { line: "1",  route: "Messegelände ↔ Sudenburg",        freq: "10 min", riders: "high"   },
  ...
  return (
    <div className="page-fade-in p-6 lg:p-8 space-y-8 max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-6 items-start">
          <div>
            ...
            <h2 className="text-xl font-bold mb-3" style={{ color: "#2D1F0F" }}>
              Getting around Magdeburg — trams, bikes, and everything in between
            </h2>
            <p className="text-[13.5px] leading-relaxed" style={{ color: "rgba(45,31,15,0.62)" }}>
              ...
              the <strong style={{ color: "#0891B2" }}>MVB (Magdeburger Verkehrsbetriebe)</strong>.
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div key={f.label} className="rounded-xl p-3.5" style={{ background: "rgba(8,145,178,0.08)", border: "1px solid rgba(8,145,178,0.18)" }}>
                <p className="text-[16px] font-bold" style={{ color: "#0891B2" }}>{f.value}</p>
                <p className="text-[11px] font-semibold mt-0.5" style={{ color: "#0891B2" }}>{f.label}</p>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <GlassCard className="p-6">
          <p className="text-[13px] font-semibold mb-1" style={{ color: "rgba(45,31,15,0.60)" }}>How Magdeburgers Travel</p>
          <p className="text-[11px] mb-5" style={{ color: "rgba(45,31,15,0.38)" }}>Modal split · 2024 survey</p>
          <div className="space-y-3">
            {modalSplit.map((m) => (
              <div key={m.name} className="flex items-center gap-4">
                ...
                <div className="w-48 rounded-full overflow-hidden" style={{ background: "rgba(160,130,90,0.12)", height: 6 }}>
          ...
          <div className="mt-5 p-3.5 rounded-xl" style={{ background: "rgba(13,148,136,0.07)", border: "1px solid rgba(13,148,136,0.18)" }}>
            <p className="text-[12px] font-semibold mb-1" style={{ color: "#0D9488" }}>2030 target</p>
            <p className="text-[11.5px] leading-snug" style={{ color: "rgba(45,31,15,0.55)" }}>
              City plan aims for Public Transit 44% / Cycling 15% / Car 25% — a major modal
        ...
        <GlassCard className="p-6">
          <p className="text-[13px] font-semibold mb-1" style={{ color: "rgba(45,31,15,0.60)" }}>Key Tram Lines</p>
          <p className="text-[11px] mb-5" style={{ color: "rgba(45,31,15,0.38)" }}>MVB tram network · selected lines</p>
          <div className="space-y-2.5">
            {tramLines.map((t) => (
              <div key={t.line} className="flex items-center gap-3 rounded-xl px-3.5 py-3"
                ...
                <p className="text-[12px] flex-1" style={{ color: "rgba(45,31,15,0.65)" }}>{t.route}</p>
                <span className="text-[10px] font-semibold shrink-0 px-2 py-0.5 rounded-full"
                  style={{ background: t.riders === "high" ? "rgba(8,145,178,0.12)" : "rgba(193,127,36,0.12)",
                           color: t.riders === "high" ? "#0891B2" : "#A36318" }}>
                  every {t.freq}
                </span>
              </div>
            ))}
          </div>
          <div className="mt-4 flex items-start gap-2 p-3 rounded-xl" style={{ background: "rgba(8,145,178,0.07)", border: "1px solid rgba(8,145,178,0.18)" }}>
            ...
            <p className="text-[11.5px] leading-snug" style={{ color: "rgba(45,31,15,0.58)" }}>
              A €180M tram network expansion is planned for 2026–2030, adding two new lines to
